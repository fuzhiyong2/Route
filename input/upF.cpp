...
bool MiddleLine(DEdge &E1,DEdge &E2){
	...
	if(!inPoly(c1,c2) || !inPoly(MiddlePoint(E1.A,c1),MiddlePoint(E1.B,c2)) || !inPoly(MiddlePoint(c1,E2.A),MiddlePoint(c2,E2.B)) ||!inPoly(MiddlePoint(E1.A,d1),MiddlePoint(E1.B,d2)))
		return 0;
	return 1;
}
void showDpoint(){
